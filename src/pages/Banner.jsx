...
const Banner = () => {
    return (
        <div>
            <div className='px-2.5 pt-[80px ] pt-2.5 md:px-[80px]'>
                <div className='text-center'>
                    <h1 className='text-4xl sm:text-5xl sm:text-nowrap lg:text-7xl font-bold text-center'>We Build <br /> <span className='text-[#9F62F2]'>Productive</span> Apps</h1>
            ...
            <div className='bg-gradient-to-r from-[#632EE3] to-[#9F62F2] mx-auto text-white py-4 md:py-[80px] px-2.5 md:px-[80px]'>
